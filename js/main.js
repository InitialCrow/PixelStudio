...
var colorPicker = new Palete(['#6E6E6E','#000000','#FF0000','#FFFF00','#00FF00','#B404AE'],'25','25');// create deafault color
var adderColor = new AdderColor('color')// create posibility to add color
var colorUser = new Palete([],'25','25');// create your color whith AdderColor
