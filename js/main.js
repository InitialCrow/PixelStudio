...
$('document').ready(function(){
	pixelStudio.init(pix,1000,paint,pen,rubber,eraser,colorPicker,adderColor,colorUser,inspirate);// params : (size, Pixel, Painttool, Pentool, Rubbertool, Erasertool, Paletetool,AdderColortool, PaleteUsertool) last for create your palete
